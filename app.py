...
# -------------- Config --------------
st.set_page_config(page_title="Bottle Art Recommender", layout="wide")
IMAGES_PER_PAGE = 12
...
# -------------- Sidebar Info --------------
with st.sidebar:
    st.title("🍾 Bottle Art Recommender")

    st.markdown("""
    **Discover beautiful bottle art crafts that inspire you.**  
    Like 👍 or dislike 👎 bottle art images and receive AI-powered recommendations tailored to your taste.
    """)

    st.markdown("### 🧠 How It Works")
    st.markdown("""
    1. Bottle art images are embedded into vector space  
    2. You provide preferences via Like/Dislike  
    3. Qdrant finds visually similar bottle art  
